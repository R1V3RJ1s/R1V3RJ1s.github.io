...
{% codeblock lang:python %}
'''
n is the number of elements you want to iterate at a time. 
Notice that last m elements aren't iterated, where m equals to the length of the contatiner mod n.
'''
