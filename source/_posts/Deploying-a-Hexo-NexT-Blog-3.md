...
打开自己的<span style="background-color:#c082ed"><font color="white">&nbsp;主题配置文件&nbsp;</font></span>并找到`creative_commons`类，做如下设置即可开启版权尾注：
...
$ npm install hexo-leancloud-counter-security --save
{% endcodeblock %}
* 如果版权信息尾注显示的本文链接有误，很可能是<span style="background-color:#4fa7f0"><font color="white">&nbsp;站点配置文件&nbsp;</font></span>中的`url`字段设置有误。
